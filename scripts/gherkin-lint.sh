...
# (unchanged). We keep a copy in the repo so CI runners (which don't have
# $HOME/.claude/) can invoke it directly. Follow-up bd tracks upstreaming to
# a pinnable version — see 000-docs/TEST_AUDIT.md → Post-audit follow-up.
#
